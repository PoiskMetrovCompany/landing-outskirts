        ...
        <div className={styles.content}>
          <section className={styles.section}>
            ...
            <p>
              ...
              ИП Плющиков Дмитрий Алексеевич (далее – Оператор).
            </p>
            <ol>
              <li>
          ...
          <section className={styles.section}>
            ...
            <ol>
              ...
              <li>
                ...
                веб-сайта <Link href={siteUrl}>{siteUrl}</Link>.
              </li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <ol start={2}>
              <li>
                ...
                электронной почты{" "}
                <a href={`mailto:${contactEmail}`}>{contactEmail}</a> с пометкой
          ...
          <section className={styles.section}>
            ...
            <ol start={2}>
              <li>
                ...
                <Link href={siteUrl}>{siteUrl}</Link> или направленные Оператору
          ...
          <section className={styles.section}>
            ...
            <ol>
              ...
              <li>
                ...
                Оператора <a href={`mailto:${contactEmail}`}>{contactEmail}</a>{" "}
          ...
          <section className={styles.section}>
            ...
            <ol>
              ...
              <li>
                ...
                сети Интернет по адресу <Link href={siteUrl}>{siteUrl}</Link>.
              </li>
            </ol>
          </section>
        </div>
